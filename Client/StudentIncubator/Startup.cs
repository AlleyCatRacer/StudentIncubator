...
namespace StudentIncubator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAvatarService, AvatarWebService>();
            services.AddScoped<ISuggestionService, SuggestionWebService>();
            services.AddScoped<IActionService, ActionWebService>();
            services.AddScoped<IFavoriteService, FavoriteWebService>();
